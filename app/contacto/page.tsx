    ...
    <main className="flex-1 pb-20 lg:pb-28">
      <div className="relative overflow-hidden">
        <BrandPatternBackground
          src="/patrones/carpeta-patrones/Mesa%20de%20trabajo%2013.png"
          opacity={0.04}
          tileSize={320}
        />
        <Container as="div" className="py-20 lg:py-28">
          ...
          <div className="mt-12 grid gap-16 lg:grid-cols-[3fr_2fr] lg:items-start lg:gap-x-16 xl:gap-x-24">
            <div className="relative min-w-0">
              ...
              <BrandIllustration
                src="/brand-elements/menesteres-elements/limon-menesteres.svg"
                size={60}
                opacity={0.15}
                rotate={-8}
                hideOnMobile
              ...
              <p className="mt-16 max-w-[46ch] font-body text-[0.9rem] leading-[1.65] text-carbon/55">
                {isEventos ? (
                  ...
                  <>
                    ...
                    ; este form es destinado a eventos privados y consultas generales.
                  </>
                )}
              </p>
            </div>
