...
export const ESPACIO_GALLERY: EspacioGalleryItem[] = [
  {
    src: "/local-menesteres/interior-local1.webp",
  ...
  {
    src: "/local-menesteres/interior-local2.webp",
  ...
  {
    src: "/local-menesteres/interior-local3.webp",
  ...
  {
    src: "/local-menesteres/interior-local9.webp",
